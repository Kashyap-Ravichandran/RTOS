...
extern osThreadId_t t_Read_TS, t_Read_Accelerometer, t_Sound_Manager, t_US, t_Refill_Sound_Buffer, t_newthread;
extern osMutexId_t LCD_mutex;
extern osMessageQueueId_t id_toADC, id_fromADC;
typedef struct{
	int channel;
}toADC;
